...
typedef struct iot_Init
{
	...
	TIM_HandleTypeDef 	*blk_1pps_out_htim;
	uint32_t 			blk_1pps_out_channel;
	uint16_t			blk_1pps_in_gpio_pin;
	int16_t				blk_1pps_in_gpio_irq;
} iot_Init_t;

typedef enum iot_GpoPinId
{
	blk_slave_1pps_dir = 0,
	select_1pps_s0,
	select_1pps_s1,
	blk_master_cable_det,
	tamper_sw,
	som_sd_boot_en,
	rcu_pwr_btn,
	rcu_pwr_en_zer,
